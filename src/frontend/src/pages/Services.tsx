...
const SERVICES = [
  ...
  },
  {
    ...
    description:
      "From your external perimeter to your internal infrastructure, our network penetration testing exposes the paths an attacker would exploit to gain a foothold. We conduct internal and external network scanning, firewall rule analysis, port enumeration, protocol weaknesses, and lateral movement simulation. Wireless network security and segmentation reviews are included on request.",
    features: [
...
function FaqItem({ q, a, index }: { q: string; a: string; index: number }) {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-display text-sm md:text-base font-semibold text-foreground group-hover:text-primary transition-smooth">
          {q}
        </span>
        <ChevronDown
...
export default function Services() {
  return (
    <main data-ocid="services.page" className="bg-background">
      {/* Hero */}
      <section className="relative pt-24 pb-16 px-4 overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_0%,oklch(var(--primary)/0.08),transparent)]" />
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-start gap-4">
                    <div className="shrink-0 p-3 rounded-lg bg-background/60 border border-border/30">
                  ...
                  {/* CTA */}
                  <div className="pt-2">
                    <Link to="/contact" data-ocid={`services.cta.${i + 1}`}>
                      <Button
                        variant="outline"
      ...
      {/* Process Section */}
      <section className="py-20 px-4" data-ocid="services.process.section">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
            {/* Connecting neon lines (desktop only) */}
            <div className="hidden md:block absolute top-12 left-[calc(33.33%+1rem)] right-[calc(33.33%+1rem)] h-px bg-gradient-to-r from-primary/50 via-accent/50 to-destructive/50 pointer-events-none z-10" />
      ...
      >
        <div className="max-w-3xl mx-auto">
          <SectionHeader
            ...
            align="center"
          />
          <div className="flex flex-col gap-3" data-ocid="services.faq.list">
            {FAQS.map((faq, i) => (
          ...
          >
            ...
            <Link to="/contact" data-ocid="services.contact_cta">
              <Button className="bg-primary text-primary-foreground hover:bg-primary/90 transition-smooth font-display uppercase tracking-wide px-8">
                Contact Us
