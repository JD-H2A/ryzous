import { c as createLucideIcon, o, r as reactExports, w as vt, j as jsxRuntimeExports, S as Shield } from "./index-C_2TD7nS.js";
import { S as SectionHeader, G as GlassCard } from "./SectionHeader-C5mfMumD.js";
import { a as useSubmitContact } from "./useBackend-BTvX7Sjt.js";
...
function Contact() {
  ...
  const inputBase = "w-full rounded-lg px-4 py-3 bg-background/60 border border-border/50 text-foreground placeholder:text-muted-foreground/60 font-body text-sm transition-smooth focus:outline-none focus:border-accent focus:[box-shadow:0_0_12px_oklch(var(--accent)/0.25)] focus:bg-background/80";
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            "aria-hidden": "true",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[600px] rounded-full bg-primary/5 blur-[120px]" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-1/4 right-1/4 w-[400px] h-[400px] rounded-full bg-accent/5 blur-[100px]" })
            ]
          }
        ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8 items-start", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                GlassCard,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-semibold text-foreground mb-6 tracking-wide uppercase", children: "Send a Message" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "form",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "button",
                            {
                              ...
                              children: isSubmitting || submitContact.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  LoaderCircle,
                                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: faqItems.map(({ q, a, icon: Icon }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassCard, { className: "flex flex-col gap-2 p-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide", children: q })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: a })
                  ] }, q))
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "aside",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassCard, { glow: "purple", className: "flex flex-col gap-6 p-6", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-xl font-bold text-foreground uppercase tracking-widest", children: "Ryzous" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs text-muted-foreground leading-relaxed", children: "Think Like a Hacker. Defend Like a Pro." })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("hr", { className: "border-border/30" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 items-start", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-0.5", children: "Headquarters" }),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 items-start", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-0.5", children: "Security Team" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "a",
                          {
                            ...
                            children: "security@ryzous.com"
                          }
                        )
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("hr", { className: "border-border/30" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 rounded-lg bg-primary/10 border border-primary/25 px-3 py-2.5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-display font-bold text-primary uppercase tracking-widest", children: "Emergency Response 24/7" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: "Critical incidents? Our rapid-response team is on call around the clock to contain breaches and neutralize threats in real time." })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassCard, { className: "p-4 flex flex-col gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide", children: "Trusted by enterprise teams" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: ["ISO 27001", "SOC 2 Type II", "OWASP Top 10", "PTES"].map(
                      (cert) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
