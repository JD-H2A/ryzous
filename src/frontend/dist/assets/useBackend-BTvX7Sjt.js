...
Service({
  ...
  "submitContact": Func([ContactInput], [Result], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const DashboardStats2 = IDL2.Record({
    "vulnerabilitiesFound": IDL2.Nat,
    "bugsFixed": IDL2.Nat,
    "totalProjects": IDL2.Nat,
    "securityScore": IDL2.Nat
  });
  ...
  const Project2 = IDL2.Record({
    ...
    "vulnerabilityType": IDL2.Text,
    "description": IDL2.Text,
    "beforeCode": IDL2.Text,
  ...
  const Result2 = IDL2.Variant({ "ok": ContactSubmission2, "err": IDL2.Text });
  return IDL2.Service({
    ...
    "submitContact": IDL2.Func([ContactInput2], [Result2], [])
  });
};
class Backend {
...
function from_candid_ProjectStatus_n4(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n5(_uploadFile, _downloadFile, value);
}
function from_candid_Project_n2(_uploadFile, _downloadFile, value) {
  return from_candid_record_n3(_uploadFile, _downloadFile, value);
}
function from_candid_Result_n9(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n10(_uploadFile, _downloadFile, value);
}
function from_candid_Severity_n6(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n5(_uploadFile, _downloadFile, value) {
  return "Fixed" in value ? "Fixed" : "InProgress" in value ? "InProgress" : value;
}
function from_candid_variant_n7(_uploadFile, _downloadFile, value) {
  return "Low" in value ? "Low" : "High" in value ? "High" : "Medium" in value ? "Medium" : "Critical" in value ? "Critical" : value;
}
